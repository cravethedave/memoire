...
\begin{longtable}{m{.075\textwidth} m{.30\textwidth} p{.025\textwidth} p{.6\textwidth}}
    ...
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``['' ``T'' hydrogen\_3 ``+'' ``]'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``X'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``R'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``T'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``['' ``C'' ``@'' hydrogen\_1 ``]'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``['' ``C'' ``@'' ``@'' hydrogen\_1 ``]'' \\
    \textcolor{green}{+} & atom\_valence\_1 & $\rightarrow$ & ``['' ``T'' hydrogen\_1 ``+'' ``]'' \\
    ...
    \textcolor{green}{+} & atom\_valence\_2 & $\rightarrow$ & ``T'' \\
    \textcolor{green}{+} & atom\_valence\_2 & $\rightarrow$ & ``['' ``C'' ``@'' hydrogen\_1 ``]'' \\
    \textcolor{green}{+} & atom\_valence\_2 & $\rightarrow$ & ``['' ``C'' ``@'' ``@'' hydrogen\_1 ``]'' \\
    \textcolor{green}{+} & atom\_valence\_2 & $\rightarrow$ & ``['' ``T'' hydrogen\_1 ``+'' ``]'' \\
    ...
    \textcolor{green}{+} & atom\_valence\_3 & $\rightarrow$ & ``['' ``T'' hydrogen\_1 ``+'' ``]'' \\
...
%region Annex C
\Annexe{Human Intuition Token to Weight Map}
\label{annex:intuition-weight-array}

Human intuition weight map to link grammar tokens to their respective estimated weight in Appendix C\@
...
%region Annex D
\Annexe{Linear Regression Token to Weight Map}
\label{annex:linreg-weight-estimation}

Linear regression weight map to link grammar tokens to their respective estimated weight in Appendix D\@
{
    \allowdisplaybreaks
    \begin{align*}
        &C \rightarrow 140,\\
